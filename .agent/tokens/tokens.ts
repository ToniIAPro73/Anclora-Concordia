// Auto-generated from base_layout_private_estates.html
export const privateEstatesCssVars = {
  "anclora-gold": "#D4AF37",
...
export type PrivateEstatesCssVarName = keyof typeof privateEstatesCssVars;

/** Returns a CSS var reference like `var(--anclora-teal-primary)` */
export function cssVar(name: PrivateEstatesCssVarName) {
  return `var(--${name})`;
}
